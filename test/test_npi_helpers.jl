@testset "NPI Helpers" begin
    import Daedalus: create_time_intervention, create_reactive_intervention,
                     create_multi_intervention
    ...
    @testset "Integration with daedalus" begin
        ...
        result = daedalus(
            "Australia", infection, npi = npi, time_end = 50.0, log_rt = false)
    ...
    @testset "Reactive intervention in simulation" begin
        ...
        infection = Daedalus.DataLoader.get_pathogen("sars-cov-2 delta")
        result = daedalus(
            "Australia", infection, npi = npi, time_end = 100.0, log_rt = false)
